...
import { useCreateActivity, useEditActivity, TeacherActivity } from '@alf/shared';
...
export default function ActivityForm({ isOpen, onClose, onSuccess, editActivity, isSuggestion }: ActivityFormProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!activityType || !lessonId || !questionText) {
        ...
        try {
            ...
            alert(`Erreur: ${error.response?.data?.message || 'Impossible de sauvegarder l\'activité'}`);
        }
    };
