...
from .media_views import TeacherMediaViewSet
...
from .conjugation_views import ConjugationView
...
router.register(r'teacher/media', TeacherMediaViewSet, basename='teacher-media')
...
urlpatterns = [
    path("tools/conjugation/", ConjugationView.as_view(), name="tool-conjugation"),
